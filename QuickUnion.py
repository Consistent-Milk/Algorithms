...
class QuickUnion():
    ...
    def root(self, element: int) -> int:
        ...
        if (0 <= element <= n):
            ...
            raise ValueError(
                f'The element to look up root must be between 0 and {n}')
    ...
    def connected(self, element_1: int, element_2: int) -> bool:
        ...
        if (0 <= element_1 <= n) and (0 <= element_2 <= n):
            ...
            raise ValueError(
                f"The elements to check for connection must be between 0 and {n}")
    ...
    def union(self, element_1: int, element_2: int) -> None:
        ...
        if (0 <= element_1 <= n) and (0 <= element_2 <= n):
            ...
            raise ValueError(
                f"The elements to connect must be between 0 and {n}")
